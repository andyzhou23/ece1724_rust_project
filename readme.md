...
- **Objective 3: Ensure the application is secure and reliable**  
  Require each user to have a unique username and a password. Implement a join code system for group participation to maintain some level ofprivacy and prevent unnecessary complications.
